...
function DetailProductPage(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:5000/productDetails/${id_barang}`)
      .then((response) => {
    ...
    axios
      .get(`http://localhost:5000/tokoDetails/${detailBarang.id_toko}`)
      .then((response) => {
  ...
  const onSubmitHandler = (e) => {
    ...
    axios
      .post(`http://localhost:5000/addCart`, payload, { withCredentials: true })
      .then((response) => {
                ...
                <div className="container-produk px-sm-0  py-3 px-lg-3 d-flex  flex-wrap">
                  <div className="thumb-image-produk">
                    <div className="gambar-produk">
                      <img
                        src={`http://localhost:5000/uploads/${detailBarang.foto}`}
                        alt="produk"
                        height="330px"
                        width="100%"
                      />
                ...
                <div className="col-lg-5 col-sm-12">
                  <div className=" thumb-toko d-flex flex-column align-items-center p-3">
                    <div className="toko-img">
                      <img
                        src={`http://localhost:5000/uploads/${toko.foto_toko}`}
                        alt="toko"
                        width="100%"
                        height="100%"
