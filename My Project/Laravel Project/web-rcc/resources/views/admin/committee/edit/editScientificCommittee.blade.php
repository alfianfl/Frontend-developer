...
{{-- content untuk edit Scientific Committee --}}
@section('content')
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid mt-5">
                <h1>Edit Scientific Committee</h1>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        {{-- Form edit Scientific Committee --}}
                        <form action="{{route('admin.update.scientific',$scientific->scientific_id)}}">
                            <div class="form-group">
                                <label for="formGroupExampleInput">Name</label>
                                <input name="name" value="{{$scientific->name}}" type="text" class="form-control"
