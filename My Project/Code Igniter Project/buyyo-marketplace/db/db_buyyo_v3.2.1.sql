...
--
-- Host: localhost
-- Generation Time: May 29, 2020 at 11:16 AM
...
CREATE TABLE `Transaksi_tryout` (
  ...
  `id_user` int(11) NOT NULL,
  `pass_rl` varchar(12) DEFAULT NULL,
  `insert_on` timestamp NOT NULL DEFAULT current_timestamp(),
  `update_on` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `Transaksi_tryout` (`id_transaksi_tryout`, `bukti`, `status`, `remind_count`, `id_tryout`, `id_user`, `insert_on`, `update_on`) VALUES
(1, NULL, 'Waiting', 1, 1, 0, '2020-05-26 03:02:31', '2020-05-27 03:53:17'),
(2, NULL, 'Waiting', 2, 1, 0, '2020-05-26 03:02:31', '2020-05-27 03:53:24'),
(3, NULL, 'Approved', 1, 1, 0, '2020-05-27 05:34:49', '2020-05-27 05:34:49'),
(4, NULL, 'Rejected', 2, 1, 0, '2020-05-27 05:39:45', '2020-05-29 09:03:18'),
(5, NULL, 'Rejected', 1, 1, 0, '2020-05-29 09:15:45', '2020-05-29 09:15:45'),
(6, NULL, 'Checking', 2, 1, 0, '2020-05-29 09:15:45', '2020-05-29 09:15:45');
...
--
ALTER TABLE `Transaksi_tryout`
  MODIFY `id_transaksi_tryout` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
