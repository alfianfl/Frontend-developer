...
// Pie Chart Pendaftar
var ctx = document.getElementById("PieChartPendaftar");
...
// Pie Chart Transaksi
var ctx = document.getElementById("PieChartTransaksi");
var myPieChart = new Chart(ctx, {
  type: 'doughnut',
  data: {
    labels: stat,
...
var myPieChart = new Chart(ctx, {
  type: 'doughnut',
  data: {
    labels: ["Telah Menyelesaikan Tryout", "Belum Menyelesaikan Tryout"],
    datasets: [{
      data: [210, 1790],
      backgroundColor: ['#0079B2', '#CCE4F0'],
    }],
  },
});
