...
<head>
  ...
  <title>Dashboard - Admin Tryout</title>
...
<body class="sb-nav-fixed">
  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <a class="navbar-brand" href="<?= base_url('admin/tryout') ?>">Buy-Yo!</a><button class="btn btn-link btn-sm order-1 order-lg-0"
      ...
      <main>
        <div class="container-fluid">
          ...
          <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Data Tryout</li>
          </ol>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <canvas id="PieChartPendaftar" width="100%" height="50"></canvas>
                </div>
            ...
            <div class="col-lg-6">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <canvas id="PieChartTransaksi" width="100%" height="50"></canvas>
                </div>
  ...
  <script src="<?php echo base_url()?>asset/admin/assets/demo/chart-pie.js"></script>
</body>
</html>