                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="<?= base_url("admin/tryout_univ/change_password_action") ?>" method="post" enctype="multipart/form-data">
                                    Password: <input type="password" name="password" id="password"><br>
                                    Confirm Password: <input type="password" name="password_confirm" id="password_confirm"><br>
