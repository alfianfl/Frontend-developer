...
class ReactAxios extends Component {
  constructor(props) {
    super(props);
    this.state = {
      members: [],
  ...
  render() {
    ...
    return (
      <div className="container mt-3">
        <h1 style={{textAlign:"center"}}> Contoh React Axios</h1>
        <div className="row">
          <div className="col-md-12 col-lg-6 mb-4" style={{ border: '1px solid black' }}>
            <h2 style={h2Style}>Member</h2>
            <div className="row">
          ...
          <div className="col-md-12 col-lg-6 mb-4" style={{ border: '1px solid black' }}>
            <h2 style={h2Style}>Form {this.state.formStatus}</h2>
